        ...
        <header id="page-header">
            <div class="flex items-center gap-x-6 bg-indigo-600 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
                <p class="text-sm/6 text-white">
                    <a href="#">
                        <strong class="font-semibold">"Open Enrollment"</strong><svg viewBox="0 0 2 2" class="mx-2 inline size-0.5 fill-current" aria-hidden="true"><circle cx="1" cy="1" r="1" /></svg>"June 7 – 9"<span aria-hidden="true"></span>
                    </a>
                </p>
    ...
    view! {
        <footer id="page-footer" class="bg-gray-900">
            <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-400">"Hivemind"</p>
            </div>
        </footer>
    }
}
...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <Title text="Welcome to Leptos CRM"/>
