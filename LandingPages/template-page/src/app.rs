...
use crate::components::faq::faq_box::FaqTwoColumnCenteredIntro;
use crate::components::claims::claims_box_form::ClaimsBoxForm;
use crate::components::hsa::hsa_box_form::HsaBoxForm;

// Utility component that serves as a styled wrapper for the content of the application.
// It’s used to standardize the layout of pages or sections by wrapping dynamic content passed as children().
#[component]
...
// Utility component that serves as a top section, typically used for displaying important announcements or notifications.
#[component]
    ...
    view! {
        <header id="page-header">
            <div class="flex items-center gap-x-6 bg-customOrange px-6 py-4 sm:px-3.5 sm:before:flex-1">
                ...
                // This section represents a dismiss button typically used to close or hide an element, such as a notification or banner.
...
// Utility component that serves as the bottom section, typically used for navigation links, social media icons, and company information.
#[component]
...
// Defines a reusable navigation bar component.
// It provides a structured way to navigate through different sections or pages.
#[component]
...
// Defines the main content area of the application, responsible for rendering different views based on the application’s routing configuration.
#[component]
